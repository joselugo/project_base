...
<ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item"><a href="#teacher">Lista de docentes</a></li>
    <li class="breadcrumb-item active">Perfil docente</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header"><i class="fa fa-user"></i> Perfil Docente</h1>
<!-- end page-header -->
...
<div class="row">
    ...
    <div class="col-lg-4 col-xlg-3 col-md-5">
        <div class="card">
            <div class="card-body">
                <center class="m-t-30">
                    <img width="100" height="100" class="avataradmin miprofile" data-name="<?= $row->nombre; ?>" style="border-radius: 50%;" />
                    <h4 class="card-title m-t-10"><?= $row->nombre; ?></h4>
                    <h6 class="card-subtitle">Docente</h6>
                    <br>
          ...
          <button type="button" onClick="getgravatar()" class="btngravatar btn btn-xs btn-white" data-toggle="tooltip" title="Obtener Avatar desde Gravatar" style="margin-right: 5px;font-size: 10px;padding: 4px 7px;"><i class="fas fa-camera-retro"></i> Gravatar</button> -->
            ...
            <center class="m-t-30">
                <div class="card-body"> <small class="text-muted"><i class="far fa-envelope" aria-hidden="true"></i> Email</small>
                    <h6><?= $row->correo; ?></h6> <small class="text-muted p-t-30 db"><i class="fas fa-mobile-alt" aria-hidden="true"></i> Teléfono Móvil</small>
                    <h6><?= $row->movil; ?></h6>
                </div>
            </center>
        </div>
        ...
        <div class="card">
            ...
            <form id="frm-login" class="form-horizontal form-material" action="sistema/update_perfil_personal" method="post">
                ...
                <ul class="nav nav-tabs profile-tab" role="tablist">
                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#datos" role="tab" aria-expanded="true">Datos</a> </li>
                    ...
                    <div class="tab-pane active" id="datos" role="tabpanel" aria-expanded="true">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Johnathan Doe" class="form-control form-control-line" name="user-nombre" value="<?= $row->nombre; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12"><i class="far fa-envelope" aria-hidden="true"></i> Email</label>
                                <div class="col-md-12">
                                    <input type="email" placeholder="johnathan@admin.com" class="form-control form-control-line" name="user-correo" value="<?= $row->correo; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="1234567890" class="form-control form-control-line" name="user-movil" value="<?= $row->movil; ?>">
                                </div>
                            </div>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="pepito123" class="form-control form-control-line" name="fb" value="<?= $row->fb; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="@luisito" class="form-control form-control-line" name="twitter" value="<?= $row->twitter; ?>">
                                </div>
                            </div> -->
                        ...
                        <div class="card-body">
                            <form class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number" name="timeout" value="<?= $row->timeout; ?>" class="form-control form-control-line" required min="0" max="59" title="Máximo 59 minutos" style="width:50%;">
